...
$stmt = $Quicktasks->busca_servico($busca, $ordem);
...
<body onscroll="scroll()">
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <form method="POST" action="../controller/filtro.php" class="botaoC">
    ...
    <main id="conteudo">
        ...
        if ($stmt->rowCount() != 0) {
            ...
            foreach ($resultado as $row) {
                ...
                //favoritos
                if (isset($id_user)) {
                    $favoritos = $Quicktasks->select_favoritos_busca($id_user, $id_produto);
                }
        ...
        ?>
                ...
                <div class="main-card">
                    ...
                    <a class="card" href="servico.php?servico=<?php echo $row['id'] ?>">
                        <div class="img-servico" style="<?php if(!empty($row['fotos'])){ echo "background-image: url(../$row[fotos])"; } ?>;"></div>
...
<script>
    ...
    function favoritar(e, id) {
        ...
        $.ajax({
            url: '../controller/favoritar.php', // Mesma página
            type: 'POST',
            data: {
                id_servico: id,
                ajax: 1
